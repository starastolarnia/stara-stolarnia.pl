---
selectorLabel: Wybierz rodzaj uroczystości
secondaryLabel: Poznaj to miejsce
...
events:
  weddings:
    ...
    imageAlt: Leśna ceremonia ślubna przed drewnianą altaną Starej Stolarni
    imagePosition: center
  communions:
    tabLabel: Komunia
    eyebrow: Komunia blisko natury
    title: Ważny dzień dziecka.
    lead: >-
    ...
    imageAlt: Jasna sala z długimi stołami przygotowanymi na rodzinne przyjęcie
    imagePosition: center
  corporate:
    tabLabel: Impreza firmowa
    eyebrow: Spotkania poza biurem
    title: Wspólny cel. Dobry wieczór.
    lead: >-
    ...
    imageAlt: Przestronna drewniana sala przygotowana na wieczorne wydarzenie firmowe
    imagePosition: center
  family:
    tabLabel: Uroczystość rodzinna
    eyebrow: Spotkania dla bliskich
    ...
    imageAlt: Kameralnie ustawione stoły w drewnianej sali na rodzinne przyjęcie
    imagePosition: center
---
