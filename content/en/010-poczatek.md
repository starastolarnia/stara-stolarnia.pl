---
selectorLabel: Choose your celebration
secondaryLabel: Discover the venue
...
events:
  weddings:
    ...
    imageAlt: A woodland wedding ceremony in front of Stara Stolarnia’s timber pavilion
    imagePosition: center
  communions:
    tabLabel: First Communion
    eyebrow: A First Communion close to nature
    title: Your child's special day.
    lead: >-
    ...
    imageAlt: A bright hall with long tables prepared for a family celebration
    imagePosition: center
  corporate:
    tabLabel: Corporate event
    eyebrow: 'Time together, away from the office'
    ...
    imageAlt: A spacious timber hall prepared for an evening company event
    imagePosition: center
  family:
    tabLabel: Family celebration
    eyebrow: Time with the people closest to you
    ...
    imageAlt: Tables arranged for an intimate family celebration in the timber hall
    imagePosition: center
---
