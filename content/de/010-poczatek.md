---
selectorLabel: Wählt den Anlass
secondaryLabel: Den Ort entdecken
...
events:
  weddings:
    ...
    imageAlt: Trauung im Grünen vor dem Holzpavillon der Stara Stolarnia
    imagePosition: center
  communions:
    tabLabel: Erstkommunion
    eyebrow: Kommunion mitten im Grünen
    title: Der Tag Eures Kindes.
    lead: >-
    ...
    imageAlt: Heller Saal mit langen Tischen für eine Familienfeier
    imagePosition: center
  corporate:
    tabLabel: Firmenfeier
    eyebrow: Gemeinsame Zeit außerhalb des Büros
    title: Euer Team. Ein guter Abend.
    lead: >-
    ...
    imageAlt: Geräumiger Holzsaal für eine abendliche Firmenveranstaltung
    imagePosition: center
  family:
    tabLabel: Familienfeier
    eyebrow: Zeit mit Euren Liebsten
    ...
    imageAlt: Tische für eine persönliche Familienfeier im Holzsaal
    imagePosition: center
---
